...
export function validate_iris_raw_archive_ref_v1(data) {
...
export function validate_iris_semantic_derivation_refs_v1(data) {
...
export function validate_iris_context_message_unit_v1(data) {
...
export function validate_iris_context_unit_source_ref_v1(data) {
...
export function validate_iris_context_unit_header_v1(data) {
...
export function validate_iris_context_unit_v2(data) {
    const validate = ajv.getSchema("iris.context_unit.v2");
    if (!validate)
        return { valid: false, errors: ["schema not registered: iris.context_unit.v2"] };
    const valid = validate(data);
    if (!valid) {
        return {
            valid: false,
...
export function validate_iris_context_generation_header_v1(data) {
...
export function validate_iris_context_generation_v2(data) {
...
export function validateSemantic_iris_semantic_context_message_user_v1(data) {
...
export function validateSemantic_iris_semantic_context_message_assistant_v1(data) {
    if (data !== null && typeof data === "object" && !Array.isArray(data)) {
        const obj = data;
        if ("contextUnitId" in obj)
            return {
...
export function validateSemantic_iris_semantic_context_message_tool_call_v1(data) {
    if (data !== null && typeof data === "object" && !Array.isArray(data)) {
        const obj = data;
        if ("contextUnitId" in obj)
            return {
...
export function validateSemantic_iris_semantic_context_message_tool_result_v1(data) {
    if (data !== null && typeof data === "object" && !Array.isArray(data)) {
        const obj = data;
        if ("contextUnitId" in obj)
            return {
...
export function validateSemantic_iris_semantic_context_message_body_event_v1(data) {
    if (data !== null && typeof data === "object" && !Array.isArray(data)) {
        const obj = data;
        if ("contextUnitId" in obj)
            return {
...
export function validateSemantic_iris_semantic_context_message_operational_v1(data) {
    if (data !== null && typeof data === "object" && !Array.isArray(data)) {
        const obj = data;
        if ("contextUnitId" in obj)
            return {
...
export function validateSemanticContent(semanticSchemaId, content) {
...
export function isKnownSemanticSchemaId(id) {
    return KNOWN_SEMANTIC_SCHEMA_IDS.includes(id);
}
